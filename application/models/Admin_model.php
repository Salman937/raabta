<?php class Admin_model extends CI_Model{
    ...
    **/
    ...
    function get_all_complaints($table,$where="")
    {
    ...
    function completed_complaints($table,$where="")
    {
    ...
    function in_progress_complaints($table,$where="")
    {
    ...
    function pending_complaints($table,$where="")
    {
    ...
    function irrelevant_complaints($table,$where="")
    {
        $this->db->select('count(*) as irrelevant')->from($table)->where('complaints_status_id',4);
    ...
    function notunderstandable_complaints($table,$where="")
    {
        $this->db->select('count(*) as notunderstandable')->from($table)->where('complaints_status_id',5);
    ...
    **/
    function live_updates($table,$where="")
    {
    ...
    **/
    function total_emergency_counts($table,$where_emergency="")
    {
        $this->db->select('count(*) as total')->from($table);

        if(!empty($where_emergency))
        {    
            $this->db->where($where_emergency);
        }
            
        $this->db->join('emergency_districts', 'emergency_contacts_detail.emergency_district_id = emergency_districts.emergency_districts_id');
        $total = $this->db->get();
    ...
    **/
    function total_license_counts($table,$where_license="")
    {
        $this->db->select('count(*) as total_records')->from($table);
                 
        if(!empty($where_license))
        {
         $this->db->where($where_license);
        }
        $this->db->join('license_districts', 'license_districts.name = license_verification.district_id');
    ...
    public function verified_licenses($table,$where_license="")
    {
    ...
    public function expired_licenses($table,$where_license="")
    {
...
/****************************************** Traffic Education Module END ***********************************************/
    ...
    **/
    ...
    function completed_complaints_list($table,$where="")
    {
        $this->db
            ->select("complaint_id, complaints.complaint_type_id, latitude, longitude, description, image, video,dated, complaint_type, status, signup.name, signup.phone_no,complaints.phone")
            ->from($table)
            ->join('signup', 'signup.signup_id = complaints.signup_id', 'INNER ')
            ->join('complaint_types','complaint_types.complaint_type_id = complaints.complaint_type_id', 'inner')
            ->join('complaints_status','complaints_status.complaints_status_id = complaints.complaints_status_id', 'inner')
    ...
    function inprogress_complaints_list($table,$where="")
    {
        $this->db
            ->select("complaint_id, complaints.complaint_type_id, latitude, longitude, description, image, video,dated, complaint_type, status, signup.name, signup.phone_no,complaints.phone")
            ->from($table)
    ...
    function irrelevant_complaints_list($table,$where="")
    {
        $this->db
            ->select("complaint_id, complaints.complaint_type_id, latitude, longitude, description, image, video,dated, complaint_type, status, signup.name, signup.phone_no,complaints.phone")
            ->from($table)
            ...
            ->join('complaint_types','complaint_types.complaint_type_id = complaints.complaint_type_id', 'inner')
            ->join('complaints_status','complaints_status.complaints_status_id = complaints.complaints_status_id', 'inner')
            ->where('complaints.complaints_status_id',4);
    ...
    function notunderstandable_complaints_list($table,$where="")
    {
        $this->db
            ->select("complaint_id, complaints.complaint_type_id, latitude, longitude, description, image, video,dated, complaint_type, status, signup.name, signup.phone_no,complaints.phone")
            ->from($table)
            ...
            ->join('complaint_types','complaint_types.complaint_type_id = complaints.complaint_type_id', 'inner')
            ->join('complaints_status','complaints_status.complaints_status_id = complaints.complaints_status_id', 'inner')
            ->where('complaints.complaints_status_id',5);
    ...
    function pending_complaints_list($table,$where="")
    {
        $this->db
            ->select("complaint_id, complaints.complaint_type_id, latitude, longitude, description, image, video,dated, complaint_type, status, signup.name, signup.phone_no,complaints.phone")
            ->from($table)
