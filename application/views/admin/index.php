      ...
      <div class="row">
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">
                <?php if(isset($all_complaints[0])){ echo $all_complaints[0]->complaints; } else{ echo 0; }?>
              </span>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text"><a href="admin/irrelevant_complaints">Irrelevant Complaints</a></span>
              <span class="info-box-number"><?php if(isset($irrelevant[0])){ echo $irrelevant[0]->irrelevant;} else echo 0; ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text"><a href="admin/notUndestandable_complaints">Not Understandable Complaints</a></span>
              <span class="info-box-number"><?php if(isset($notunderstandable[0])){ echo $notunderstandable[0]->notunderstandable;} else echo 0; ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
