                ...
                <form class="form-horizontal" action="<?php echo base_url()?>dashboard/Traffic_wardens/add_duty_point" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          <input type="text" class="form-control" name="duty_point" id="duty_point" maxlength="30" placeholder="Traffic Warden Duty Point" required>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          <input type="text" class="form-control" name="lat" id="lat" maxlength="30" placeholder="Enter Latitude" required>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          <input type="text" class="form-control" name="long" id="long" maxlength="30" placeholder="Enter Logitude" required>
