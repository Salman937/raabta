...
class Complaints extends CI_Controller
{
    ...
    public function image()
    {
        ...
        $phone_no = $this->common_model->getAllData('signup', '*', 1, array('signup_id' => $this->input->post('signup_id')));
        // pr($phone_no);die;
        ...
        $dataImage = array(
            ...
            'phone' => ($phone_no->signup_id == 185) ? $this->input->post('phone') : $phone_no->phone_no,
        ...
        $array = array(
            'complaint_id' => $lastId,
            'complaint_response' => "Complaint is Pending",
            'response_status' => 2,
            'res_status' => 'pending',
            'admin_id' => 1,
        );
