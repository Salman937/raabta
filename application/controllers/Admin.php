...
class Admin extends CI_Controller
{
    ...
    function complaintList()
    {
        ...
        foreach ($allComplaints as $each) {
            ...
            $fetchAllUsers[] = array(
                ...
                // '7' => date("d M Y", strtotime($each->dated)),
                '8' => $Status,
                '7' => $Button,
            );
            $i++;
    ...
    public function edit_complaint($id)
    {
        ...
        $data['districts'] = $this->common_model->getAllData('emergency_districts', '*');
    ...
    public function peshawar_complaints()
    {
        // Prevent from Direct Access
        if (!isset($_SESSION['admin_id'])) {
            redirect('admin/login');
        ...
        $data['page_name'] = 'admin/complaints/peshawar-complaints';

        //Json Complete list
        $this->load->view('template', $data);
    }

    public function get_peshawar_complaints()
    {
        $where = array(
        ...
        foreach ($completedList as $each) {
            ...
            if ($each->status == 'Completed') {
                ...
                $Button .= '<a onclick="return confirm("Are you sure you want to delete this?");" href="admin/delete_complaint/' . $each->complaint_id . '" class="btn btn-danger btn-xs disabled-link btn-xs"><i class="fa fa-trash-o"></i></a> </div>';
            }
    ...
    public function peshawar_pending_complaints()
    {
        // Prevent from Direct Access
        if (!isset($_SESSION['admin_id'])) {
            redirect('admin/login');
        ...
        $data['title'] = 'Traffic Police | Complaints';
        $data['heading'] = 'Peshawar Complaints';
        $data['page_name'] = 'admin/complaints/peshawar-pending-list';

        //Json Complete list
        $this->load->view('template', $data);
    }

    public function get_peshawar_pending_complaints()
    {
        $where = array(
            'district' => $this->session->userdata('admin_district')
        );

        $completedList = $this->Admin_model->pending_complaints_list('complaints', $where);
    ...
    public function peshawar_inprogress_complaints()
    {
        // Prevent from Direct Access
        if (!isset($_SESSION['admin_id'])) {
            redirect('admin/login');
        ...
        $data['title'] = 'Traffic Police | Complaints';
        $data['heading'] = 'Peshawar Complaints';
        $data['page_name'] = 'admin/complaints/peshawar-inprogress-list';

        //Json Complete list
        $this->load->view('template', $data);
    }

    public function get_peshawar_inprogress_complaints()
    {
        $where = array(
            'district' => $this->session->userdata('admin_district')
        );

        $completedList = $this->Admin_model->inprogress_complaints_list('complaints', $where);
    ...
    public function peshawar_irrelevant_complaints()
    {
        // Prevent from Direct Access
        if (!isset($_SESSION['admin_id'])) {
            redirect('admin/login');
        ...
        $data['title'] = 'Traffic Police | Complaints';
        $data['heading'] = 'Peshawar Complaints';
        $data['page_name'] = 'admin/complaints/peshawar-irrelevant-list';

        //Json Complete list
        $this->load->view('template', $data);
    }

    public function get_peshawar_irrelevant_complaints()
    {
        $where = array(
            'district' => $this->session->userdata('admin_district')
        );

        $completedList = $this->Admin_model->irrelevant_complaints_list('complaints', $where);
    ...
    public function peshawar_not_understandable_complaints()
    {
        // Prevent from Direct Access
        if (!isset($_SESSION['admin_id'])) {
            redirect('admin/login');
        ...
        $data['title'] = 'Traffic Police | Complaints';
        $data['heading'] = 'Peshawar Complaints';
        $data['page_name'] = 'admin/complaints/peshawar-not-understandable-list';

        //Json Complete list
        $this->load->view('template', $data);
    }

    public function get_peshawar_not_understandable_complaints()
    {
        $where = array(
            'district' => $this->session->userdata('admin_district')
        );

        $completedList = $this->Admin_model->notunderstandable_complaints_list('complaints', $where);
    ...
    public function all_peshawar_complaints()
    {
        // Prevent from Direct Access
        if (!isset($_SESSION['admin_id'])) {
            redirect('admin/login');
        ...
        $data['title'] = 'Traffic Police | Complaints';
        $data['heading'] = 'Peshawar Complaints';
        $data['page_name'] = 'admin/complaints/all-peshawar-complaints';

        //Json Complete list
        $this->load->view('template', $data);
    }

    public function get_all_peshawar_complaints()
    {
        $where = array(
            'district' => $this->session->userdata('admin_district')
        );

        $completedList = $this->Admin_model->get_complaints('complaints', $where);
    ...
    public function print_complaint($id)
    {
        ...
        $data['title'] = 'Traffic Police | Complaints';
        $data['heading'] = 'Print Complaint';
        $data['page_name'] = 'admin/complaints/print_complaint';

        $where = array(
            'complaints_status' => 'complaints.complaints_status_id = complaints_status.complaints_status_id'
        );

        $data['print'] = $this->common_model->DJoin('*', 'complaints', 'signup', 'complaints.signup_id = signup.signup_id', $where, array('complaint_id' => $id));
